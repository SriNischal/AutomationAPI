...
public class WireMockGetAkamai {
    ...
    public void get() throws URISyntaxException {
        String token = "UJHIUHNDKJDFOWUIFNDOWEI";
        String clienttoken = "LKKNDFKWENJFOWINOIEFNOWINEK";
        String clientsecret = "WKEFNOWIEFNOWIENNFOIWJOIKENFOIWIEJFFOWE";
        Map<String, String> header = new HashMap();
        String[] headers = { token, clienttoken, clientsecret };
