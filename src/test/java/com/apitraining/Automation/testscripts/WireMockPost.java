...
public class WireMockPost {
    ...
    public void beforeTest() throws Exception {
        ...
        FileReader jsondata = new FileReader(ProjectbasedConstantPaths.Json_postwiremockData);
    ...
    public static void setup() {
        ...
        WireMock.stubFor(WireMock.post("/api/wiremockapi/create").willReturn(mockResponse));
    }
    @Test
    public void post() throws URISyntaxException {
        Response res = RestAssured.given().baseUri("http://localhost:8080").body(input.toString())
                .accept(ContentType.JSON).when().post("/api/wiremockapi/create").then().assertThat().statusCode(200).and()
