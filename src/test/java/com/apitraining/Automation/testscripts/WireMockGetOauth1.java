...
public class WireMockGetOauth1 {
    ...
    public void get() throws URISyntaxException {
    	String ConsumerKey = "ABC123DEF456GHI789";
    	String ConsumerSecret = "secret123";
    	...
    	String TokenSecret = "abcdefgh123456";
    	Map<String, String> header = new HashMap();
        String[] headers = { ConsumerKey, ConsumerSecret, AccessToken, TokenSecret };
