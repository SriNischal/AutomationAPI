...
public class WireMockGetOauth2 {
    ...
    public void get() throws URISyntaxException {
        ...
        Response response = RestAssured.given().baseUri("http://localhost:8080").header("Authentication", "application/json").auth().oauth2("LKKNDFKWENJFOWINOIEFNOWINEK")
